...
def main():
    ...
    # __file__ lives at <repo_root>/caveman-compress/scripts/benchmark.py
    # Walk up three dirs: scripts → caveman-compress → repo_root.
    tests_dir = Path(__file__).resolve().parents[2] / "tests" / "caveman-compress"
