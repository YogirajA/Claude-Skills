...
- `GLOSSARY.md`: The canonical language for this teaching workspace. Every lesson, reference document, and learning record adheres to its terminology once it exists. Use the format in [GLOSSARY-FORMAT.md](./GLOSSARY-FORMAT.md).
