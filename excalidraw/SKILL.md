...
metadata:
  origin: ooiyeefei/ccc
  imported: "2026-09-04: copied from the MIT skills/ surface. The ccc plugin marketplace is deliberately NOT installed; third-party plugin sources are out of policy, so this skill is vendored like the Pocock, Caveman and ECC imports."
---
