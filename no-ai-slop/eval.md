...
9. Are em dashes gone entirely, each replaced with a comma, a colon, parentheses, or a restructured sentence, with en dashes kept only for date and number ranges?
